...
//
    ...
    public $apiName = "/auth/token/create"; //Your Desired API
...
//Generate Final API Data
    public function generateResult(){
        $request = $this->requestSeller('/auth/token/create','GET');
        $this->addApiParam('code','4_500376_PugoYcmuwMuYo4yYCG8e6Omy207');
